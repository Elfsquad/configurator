...
describe("configuration", () => {
  ...
  it("should call correct endpoint for updateRequirement", async () => {
    ...
    expect(lastRequest.url).toContain(
      `${API_URL}/configurator/3/configurator/test-id?ignoreConflicts=`
    );
  ...
  it("should call correct endpoint for updateCardinality", async () => {
    ...
    expect(lastRequest.url).toBe(
      `${API_URL}/configurator/3/configurator/test-id/updatelinkedconfigurationcardinality`
    );
    expect(lastRequest.method).toBe("PUT");
  });
  ...
  it("should call correct endpoint for getStepImage", async () => {
    ...
    expect(lastRequest.url).toContain(
      `${API_URL}/configurator/3/configurator/test-id/image?stepId=`
    );
